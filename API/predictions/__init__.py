...
def recognize(out_file, img_name, full_img_path, most_common, coord_imgs, imgs_with_staff, imgs_spacing, imgs_rows, instrament):
    ...
    no_staff = f'API/predictions/output/nostaff_detected_{i}.png'
    overlay = f"API/predictions/output/{img_name}_overlay_{i}.png"
    output = f"API/predictions/output/output_{img_name}.png"
    ...
    return_dict["overlayed_img_name"] = output
    return return_dict
...
def make_predictions(filepath, instrament):
    ...
    print("Recognize...")
    return_dict = recognize(out_file, img_name, full_img_path, most_common, coord_imgs,
